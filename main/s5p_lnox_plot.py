...
INPUT:
    ...
    - lno2_cases csv file generated by `s5p_lno2_cases.py`
...
def main():
    ...
    case_list = glob(case_dir+'/lno2_cases_*csv')
    ...
    _ = df.groupby(['case']).parallel_apply(plot_data)
